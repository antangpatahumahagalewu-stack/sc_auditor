...
SERVICE_REGISTRY: dict[str, str] = {
    "scanner": "http://scanner:8000/health",
    "ai": "http://ai:8000/health",
    "classifier": "http://classifier:8000/health",
    "exploit": "http://exploit:8000/health",
    "reporter": "http://reporter:8000/health",
    "notifier": "http://notifier:8000/health",
    "orchestrator": "http://orchestrator:8000/health",
    "source": "http://source:8000/health",
    "immunefi": "http://immunefi:8000/health",
    "webhook": "http://webhook:8000/health",
    "config": "http://config:8000/health",
}
