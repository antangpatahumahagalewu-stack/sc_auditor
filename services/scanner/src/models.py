"""Pydantic v2 models for the Vyper Scanner Service.
...
class ScanRequest(BaseModel):
    ...
    Attributes:
        ...
        tools: List of tools to run. Defaults to all available.
        config_tier: Slither config preset ("strict", "default", "noisy").
        mythril_timeout: Mythril analysis timeout in seconds.
        echidna_timeout: Echidna fuzzing timeout in seconds.
...
class ScanResponse(BaseModel):
    ...
    Attributes:
        ...
        forge: Forge compilation result.
